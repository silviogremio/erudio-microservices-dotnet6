...
namespace GeekShopping.ProductAPI.Model.Context
{
    public class MySQLContext : DbContext
    {
		...
		//Esse método protegido abaixo é para sanear a base de dados
		...
		//Criando as Migrations dos produtos
		//Comando: dotnet ef migrations add SeedProductsDataTable
		//Rodando o Seed: dotnet ef database update
